...
export default class MovieListPresenter {
    ...
    #handleModelEvent = (updateType, data, isPopupOpened) => {
      ...
      const comments = this.movieComments;

      switch (updateType) {
        case UpdateType.PATCH:
          this.#cardPresenterMap.get(data.id).init(data, comments);
          break;
    ...
    #renderCard = (card, comments) => {
      ...
      const cardPresenter = new MovieCardPresenter(this.#filmsListContainer, this.#footerContainer, this.#handleViewAction, this.#handleCloseOldCardPopup);
    ...
    #renderCards = (cards) => {
      const comments = this.movieComments;
      cards.forEach((card) => this.#renderCard(card, comments));
    }
